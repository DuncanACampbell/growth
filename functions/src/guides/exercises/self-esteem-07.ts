...
Don't worry about summarising everything. Just tell me the biggest thing that stands out.`,
  whatToUnderstand:
    'Identify what they believe they have learned, which external measures have had too much power, which internal qualities or standards now feel more important, and what they would like to do differently when self-judgment appears again. Work first from what they say in this conversation. If earlier-day programme memory is present, you may use it to recognise patterns they already named — do not invent discoveries they never made.',
  reframeGoal:
