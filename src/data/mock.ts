...
export const THEME_PRICE_EUR = 3;
...
export const MOCK_THEMES: Theme[] = [
  ...
  listedTheme('theme-relationships', 'Relationships', 'Becoming a better partner and building healthier relationships', 'comingSoon'),
  listedTheme('theme-anxiety', 'Anxiety', 'Understanding triggers, uncertainty, worry and coping patterns', 'comingSoon'),
  listedTheme('theme-happiness', 'Happiness', 'Discovering what actually makes your life feel good and meaningful', 'comingSoon'),
  listedTheme('theme-purpose', 'Purpose', 'Exploring what matters to you and what you want your life to stand for', 'comingSoon'),
  listedTheme('theme-confidence', 'Confidence', 'Becoming more comfortable taking risks, speaking up and being seen', 'comingSoon'),
  listedTheme('theme-overthinking', 'Overthinking', 'Recognizing rumination and learning when to stop analyzing', 'comingSoon'),
  listedTheme('theme-career', 'Career', 'Understanding ambition, satisfaction, strengths and what you want from work', 'comingSoon'),
  listedTheme('theme-body-image', 'Body Image', 'Changing how you think about appearance, attractiveness and your body', 'comingSoon'),
